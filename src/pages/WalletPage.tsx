    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        ...
        <motion.div
          initial={{ scale: 0.95 }}
          animate={{ scale: 1 }}
          className="bg-gradient-to-br from-[hsl(210,60%,45%)] to-[hsl(210,70%,35%)] text-white rounded-2xl p-5 text-center shadow-lg relative"
        >
          ...
          <Button
            ...
            className="mt-2 bg-white/20 hover:bg-white/30 text-white rounded-xl text-xs px-3 py-1 h-auto"
          >
          ...
          >
            ...
            <div className="flex gap-2">
              <Input
                ...
                step="0.01"
              />
              <Button onClick={handleTopUp} className="gradient-farm text-primary-foreground rounded-xl font-bold px-6">
                Pay 💳
              </Button>
            </div>
            ...
            return (
              <div key={tx.id} className="bg-card border rounded-xl overflow-hidden">
                <button
                  ...
                  className={`w-full flex items-center gap-3 p-3 text-left ${hasItems ? 'cursor-pointer hover:bg-accent/50' : 'cursor-default'}`}
                >
                  {isRM ? (
                  ...
                  {isExpanded && hasItems && (
                    ...
                    >
                      <div className="p-3 space-y-1.5">
                        <p className="text-xs font-bold text-muted-foreground mb-1">Items Purchased:</p>
                        {tx.items!.map((item, i) => (
